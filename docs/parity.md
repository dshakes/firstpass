...
| 4 | Agent launchers (`firstpass launch …`) | One command beats a page of env-var instructions | S | planned |
| 5 | Reasoning-effort normalization | Providers spell effort differently; agents should not care which is behind us | S | planned |
